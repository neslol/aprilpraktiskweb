export default function Final() {
    return (
        <>
            <header className="fixed inset-x-0 top-0 z-50 bg-transparent px-4 py-4 text-white">
      ...
      <section className="relative h-screen overflow-hidden bg-[url('/hero.jpg')] bg-center bg-cover text-white text-xl">
        <div className="backdrop-brightness-50 absolute inset-0 flex flex-col items-center justify-center text-center gap-4">
          ...
          <div className="flex flex-col text-center gap-6 mt-4">
            <a href="youtube.com" className="flex items-center gap-2 text-white text-lg max-w-62.5 sm:max-w-125">
