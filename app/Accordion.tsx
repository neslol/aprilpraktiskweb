...
const Accordion = () => {
  return (
    <section className="bg-[#936639] text-white p-5 md:px-10 lg:px-20 xl:px-40">
            ...
            <div className="mt-6">
              <details className="program-accordion border-y-2 border-white" open>
                <summary className="flex cursor-pointer list-none items-center justify-between py-4">
                  <span className="text-2xl lg:text-[28px] xl:text-[32px] 2xl:text-[36px]">Dag 1 - Lorem Ipsum</span>
                  <svg
              ...
              <details className="program-accordion border-b-2 border-white">
                <summary className="flex cursor-pointer list-none items-center justify-between py-4">
                  <span className="text-2xl lg:text-[28px] xl:text-[32px] 2xl:text-[36px]">Dag 2 - Lorem Ipsum</span>
                  <svg
                    className="program-chevron h-6 w-6 md:h-8 md:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 2xl:h-14 2xl:w-14 shrink-0 transition-transform duration-300"
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <details className="program-accordion border-b-2 border-white">
                <summary className="flex cursor-pointer list-none items-center justify-between py-4">
                  <span className="text-2xl lg:text-[28px] xl:text-[32px] 2xl:text-[36px]">Dag 3 - Lorem Ipsum</span>
                  <svg
                    className="program-chevron h-6 w-6 md:h-8 md:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 2xl:h-14 2xl:w-14 shrink-0 transition-transform duration-300"
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <details className="program-accordion border-b-2 border-white">
                <summary className="flex cursor-pointer list-none items-center justify-between py-4">
                  <span className="text-2xl lg:text-[28px] xl:text-[32px] 2xl:text-[36px]">Dag 4 - Lorem Ipsum</span>
                  <svg
                    className="program-chevron h-6 w-6 md:h-8 md:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 2xl:h-14 2xl:w-14 shrink-0 transition-transform duration-300"
                    viewBox="0 0 24 24"
                    fill="none"
